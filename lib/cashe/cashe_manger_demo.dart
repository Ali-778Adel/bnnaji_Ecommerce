...
import 'package:bnnaji/cashe/webHelper.dart';
...
Category_Cubit category_cubit;
  ...
  Future<FileInfo> downloadFile(String url,
    ...
    key ??= url;
    var fileResponse = await WebHelper()
        .downloadFile(
      url,
      key: key,
     ...
     print ('good evening with cash');
    print(fileResponse.toString());
